...
def test_about_page(browser):
    ...
    assert testpage.get_element_text(TestSearchLocators.ids["LOCATOR_ABOUT_PAGE_HEADER"]) == "Blog"
    assert testpage.get_element_font_size(TestSearchLocators.ids["LOCATOR_ABOUT_PAGE_HEADER"]) == "64px"
