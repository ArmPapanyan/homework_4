...
class OperationHelper(BasePage):
    ...
    def test_contact_us(self):
        ...
        self.find_element(TestSearchLocators.LOCATOR_OUR_NAME_FIELD).send_keys("arpamipa8844444")
        self.find_element(TestSearchLocators.LOCATOR_EMAIL_FIELD).send_keys("armpapanyanh@gmail.com")
